...
const Header: React.FC = () => {
    ...
    return (
        <header className="relative w-full bg-base-100 h-[75vh] md:h-[85vh] flex flex-col items-center justify-center overflow-hidden border-b border-white/5 transition-all duration-1000 ease-out">
            ...
            <div className="relative group z-10 flex flex-col items-center gap-2 text-center -translate-y-16 md:-translate-y-24 lg:-translate-y-28 transition-transform duration-1000">
                ...
                <div className="flex flex-col items-center gap-3 animate-fade-in pointer-events-none px-6">
                    <span className="text-[9px] tracking-[0.8em] uppercase font-black text-white/30 mb-1 italic">A Legacy of Taste</span>
