...
const Header: React.FC = () => {
    ...
    return (
        <header className="relative w-full bg-base-100 h-[70vh] md:h-[80vh] flex flex-col items-center justify-center overflow-hidden border-b border-white/5 transition-all duration-1000 ease-out">
            ...
            <div className="relative group z-10 flex flex-col items-center gap-4 text-center -translate-y-8 md:-translate-y-12">
                <div className="relative p-6 transition-transform duration-1000 hover:scale-[1.03] flex flex-col items-center">
                    ...
                    <img 
                        src={logoUrl} 
                        alt="Kargil Kitchen" 
                        className="h-60 w-60 md:h-80 md:w-80 lg:h-[420px] lg:w-[420px] object-contain filter brightness-110 drop-shadow-[0_0_90px_rgba(255,255,255,0.2)] transition-all duration-700"
                    />
                </div>

                <div className="flex flex-col items-center gap-3 animate-fade-in pointer-events-none px-6">
                    <span className="text-[9px] tracking-[0.7em] uppercase font-black text-white/40 mb-1 italic">A Legacy of Taste</span>
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-serif italic text-white/95 max-w-3xl leading-[1.1] tracking-tight">
                        Refining the Art of <br className="hidden md:block" /> Authentic Flavors
                    </h1>
                    <div className="w-20 h-[1px] bg-gradient-to-r from-transparent via-white/30 to-transparent mt-4 shadow-sm"></div>
                </div>
            </div>
            ...
            <style>{`
                ...
                .animate-fade-in {
                    animation: fade-in 2.5s cubic-bezier(0.16, 1, 0.3, 1) 0.5s forwards;
                    opacity: 0;
                }
            `}</style>
        </header>
